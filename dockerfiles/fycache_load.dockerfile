...
FROM fycache:20200421

RUN --mount=type=cache,uid=1000,id=fycache,target=/fycache,sharing=shared \  
    # mkdir -p /fycache/centos_8 ; \
    # mkdir -p /fycache/sources  ; \
    # mkdir -p /fycache/centos_8/modules/all ; \ 
    # mkdir -p /fycache/centos_8/ebfiles_repo ;\ 
    mkdir -p /fycache/centos_8/software ; \ 
    ...
    #     cp -r /fuyun/software/${_name}   /fycache/centos_8/software/${_name}  ; \
    # done ;\
    rm -rf /fycache/centos_8/modules/all/PostgreSQL ;\
    rm -rf /fycache/centos_8/modules/data/PostgreSQL ;\
    rm -rf /fycache/centos_8/software/PostgreSQL ;\
    rm -rf /fycache/centos_8/ebfiles_repo/PostgreSQL ;\
