...
pip3 install --prefix ${FY_ROOT}/software/EasyBuild/${FY_EB_VERSION}_pip easybuild
export PATH=${FY_ROOT}/software/EasyBuild/${FY_EB_VERSION}_pip/bin:${PATH}
export PYTHONPATH=${FY_ROOT}/software/EasyBuild/${FY_EB_VERSION}_pip/lib/python3.6/site-packages/:${PYTHONPATH}
export EASYBUILD_PREFIX=${FY_ROOT}
export EB_PYTHON=/usr/bin/python3
eb  --install-latest-eb-release

# if ! [ -f ${FY_ROOT}/sources/bootstrap/easybuild-easyconfigs-v${FY_EB_VERSION}.tar.gz   ]; then 
...
# /usr/bin/python3 ${FY_ROOT}/sources/bootstrap/bootstrap_eb.py  ${FY_EB_PREFIX}  
